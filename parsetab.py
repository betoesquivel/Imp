...
_lr_productions = [
  ...
  ('declarationD -> , declarationB','declarationD',2,'p_declarationD','parser.py',77),
  ('declarationD -> ;','declarationD',1,'p_declarationD','parser.py',78),
  ('main -> MAIN ( ) block','main',4,'p_main','parser.py',82),
  ('suprafunc -> func block','suprafunc',2,'p_suprafunc','parser.py',86),
  ('func -> DEF returntype ID ( paramsOpt )','func',6,'p_func','parser.py',89),
  ('paramsOpt -> params','paramsOpt',1,'p_paramsOpt','parser.py',92),
  ('paramsOpt -> empty','paramsOpt',1,'p_paramsOpt','parser.py',93),
  ('block -> { instructionsOpt }','block',3,'p_block','parser.py',97),
  ('instructionsOpt -> instruction instructionsOpt','instructionsOpt',2,'p_instructionsOpt','parser.py',100),
  ('instructionsOpt -> empty','instructionsOpt',1,'p_instructionsOpt','parser.py',101),
  ('assign -> ID dimensionsOpt = superexpression','assign',4,'p_assign','parser.py',105),
  ('assignB -> dimensionsOpt = superexpression','assignB',3,'p_assignB','parser.py',108),
  ('dimensionsOpt -> dimensions','dimensionsOpt',1,'p_dimensionsOpt','parser.py',111),
  ('dimensionsOpt -> empty','dimensionsOpt',1,'p_dimensionsOpt','parser.py',112),
  ('condition -> IF ( superexpression ) block else','condition',6,'p_condition','parser.py',116),
  ('else -> ELSE block','else',2,'p_else','parser.py',120),
  ('else -> empty','else',1,'p_else','parser.py',121),
  ('instruction -> assignfunccall ;','instruction',2,'p_instruction','parser.py',125),
  ('instruction -> output ;','instruction',2,'p_instruction','parser.py',126),
  ('instruction -> return ;','instruction',2,'p_instruction','parser.py',127),
  ('instruction -> input ;','instruction',2,'p_instruction','parser.py',128),
  ('instruction -> declaration','instruction',1,'p_instruction','parser.py',129),
  ('instruction -> condition','instruction',1,'p_instruction','parser.py',130),
  ('instruction -> whileloop','instruction',1,'p_instruction','parser.py',131),
  ('instruction -> forloop','instruction',1,'p_instruction','parser.py',132),
  ('instruction -> localdirective','instruction',1,'p_instruction','parser.py',133),
  ('assignfunccall -> ID assignfunccallB','assignfunccall',2,'p_assignfunccall','parser.py',138),
  ('assignfunccallB -> ( funccallB','assignfunccallB',2,'p_assignfunccallB','parser.py',141),
  ('assignfunccallB -> assignB','assignfunccallB',1,'p_assignfunccallB','parser.py',142),
  ('localdirective -> localvardirective','localdirective',1,'p_localdirective','parser.py',146),
  ('localdirective -> localdecisiondirective','localdirective',1,'p_localdirective','parser.py',147),
  ('localdirective -> localmsgdirective','localdirective',1,'p_localdirective','parser.py',148),
  ('superexpression -> expression superexpressionB','superexpression',2,'p_superexpression','parser.py',152),
  ('superexpressionB -> & & superexpression','superexpressionB',3,'p_superexpressionB','parser.py',155),
  ('superexpressionB -> | | superexpression','superexpressionB',3,'p_superexpressionB','parser.py',156),
  ('superexpressionB -> empty','superexpressionB',1,'p_superexpressionB','parser.py',157),
  ('expression -> exp expressionB','expression',2,'p_expression','parser.py',161),
  ('expressionB -> < exp','expressionB',2,'p_expressionB','parser.py',164),
  ('expressionB -> > exp','expressionB',2,'p_expressionB','parser.py',165),
  ('expressionB -> < > exp','expressionB',3,'p_expressionB','parser.py',166),
  ('expressionB -> = = exp','expressionB',3,'p_expressionB','parser.py',167),
  ('expressionB -> < = exp','expressionB',3,'p_expressionB','parser.py',168),
  ('expressionB -> > = exp','expressionB',3,'p_expressionB','parser.py',169),
  ('expressionB -> empty','expressionB',1,'p_expressionB','parser.py',170),
  ('exp -> term expB','exp',2,'p_exp','parser.py',174),
  ('expB -> - exp','expB',2,'p_expB','parser.py',177),
  ('expB -> + exp','expB',2,'p_expB','parser.py',178),
  ('expB -> empty','expB',1,'p_expB','parser.py',179),
  ('term -> factor termB','term',2,'p_term','parser.py',183),
  ('termB -> / term','termB',2,'p_termB','parser.py',186),
  ('termB -> * term','termB',2,'p_termB','parser.py',187),
  ('termB -> empty','termB',1,'p_termB','parser.py',188),
  ('factor -> signB constant','factor',2,'p_factor','parser.py',194),
  ('factor -> ( superexpression )','factor',3,'p_factor','parser.py',195),
  ('factor -> funccall','factor',1,'p_factor','parser.py',196),
  ('factor -> ID dimensionsOpt','factor',2,'p_factor','parser.py',197),
  ('signB -> sign','signB',1,'p_signB','parser.py',200),
  ('signB -> empty','signB',1,'p_signB','parser.py',201),
  ('constant -> FCONST','constant',1,'p_constant','parser.py',205),
  ('constant -> ICONST','constant',1,'p_constant','parser.py',206),
  ('constant -> TRUE','constant',1,'p_constant','parser.py',207),
  ('constant -> FALSE','constant',1,'p_constant','parser.py',208),
  ('sign -> +','sign',1,'p_sign','parser.py',212),
  ('sign -> -','sign',1,'p_sign','parser.py',213),
  ('whileloop -> WHILE ( superexpression ) block','whileloop',5,'p_whileloop','parser.py',217),
  ('type -> INT','type',1,'p_type','parser.py',221),
  ('type -> FLOAT','type',1,'p_type','parser.py',222),
  ('type -> STRING','type',1,'p_type','parser.py',223),
  ('type -> BOOL','type',1,'p_type','parser.py',224),
  ('returntype -> VOID','returntype',1,'p_returntype','parser.py',229),
  ('returntype -> type','returntype',1,'p_returntype','parser.py',230),
  ('forloop -> FOR ( assign ; superexpression ; superexpression ) block','forloop',9,'p_forloop','parser.py',234),
  ('input -> INPUT ( ID inputB )','input',5,'p_input','parser.py',238),
  ('inputB -> , ID inputB','inputB',3,'p_inputB','parser.py',241),
  ('inputB -> empty','inputB',1,'p_inputB','parser.py',242),
  ('output -> PRINT ( outputB','output',3,'p_output','parser.py',245),
  ('outputB -> STRING outputC','outputB',2,'p_outputB','parser.py',248),
  ('outputB -> superexpression outputC','outputB',2,'p_outputB','parser.py',249),
  ('outputC -> )','outputC',1,'p_outputC','parser.py',252),
  ('outputC -> , outputB','outputC',2,'p_outputC','parser.py',253),
  ('localvardirective -> # localvardirectiveB ID','localvardirective',3,'p_localvardirective','parser.py',257),
  ('localvardirectiveB -> TRACK','localvardirectiveB',1,'p_localvardirectiveB','parser.py',260),
  ('localvardirectiveB -> FORGET','localvardirectiveB',1,'p_localvardirectiveB','parser.py',261),
  ('localmsgdirective -> # SHOW STRING','localmsgdirective',3,'p_localmsgdirective','parser.py',265),
  ('localdecisiondirective -> TRACKDECISION','localdecisiondirective',1,'p_localdecisiondirective','parser.py',269),
  ('localdecisiondirective -> FORGETDECISION','localdecisiondirective',1,'p_localdecisiondirective','parser.py',270),
  ('localdecisiondirective -> empty','localdecisiondirective',1,'p_localdecisiondirective','parser.py',271),
  ('funccall -> ID ( funccallB','funccall',3,'p_funccall','parser.py',275),
  ('funccallB -> superexpression funccallC','funccallB',2,'p_funccallB','parser.py',278),
  ('funccallB -> )','funccallB',1,'p_funccallB','parser.py',279),
  ('funccallC -> , superexpression funccallC','funccallC',3,'p_funccallC','parser.py',282),
  ('funccallC -> )','funccallC',1,'p_funccallC','parser.py',283),
  ('dimensions -> [ superexpression ] dimensionsB','dimensions',4,'p_dimensions','parser.py',287),
  ('dimensionsB -> [ superexpression ]','dimensionsB',3,'p_dimensionsB','parser.py',291),
  ('dimensionsB -> empty','dimensionsB',1,'p_dimensionsB','parser.py',292),
  ('return -> RETURN superexpression','return',2,'p_return','parser.py',297),
  ('params -> type ID paramsB','params',3,'p_params','parser.py',301),
  ('paramsB -> , type ID paramsB','paramsB',4,'p_paramsB','parser.py',304),
  ('paramsB -> empty','paramsB',1,'p_paramsB','parser.py',305),
