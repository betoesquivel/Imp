...
_lr_signature = '\xa8+\xca\x8e[\xbf\x1aQ\xe8\x03/F\x1d\xf9\x1c:'
...
_lr_productions = [
  ...
  ('new_dimension -> <empty>','new_dimension',0,'p_new_dimension','parser.py',913),
  ('dimensions -> [ new_dimension hyperexpression seen_dimensionx ] dimensionsB','dimensions',6,'p_dimensions','parser.py',918),
  ('dimensionsB -> [ hyperexpression seen_dimensiony ]','dimensionsB',4,'p_dimensionsB','parser.py',943),
  ('dimensionsB -> empty','dimensionsB',1,'p_dimensionsB','parser.py',944),
  ('return -> RETURN hyperexpression','return',2,'p_return','parser.py',948),
  ('return_quadruple -> <empty>','return_quadruple',0,'p_return_quadruple','parser.py',967),
  ('params -> type ID','params',2,'p_params','parser.py',986),
  ('paramsB -> , params paramsB','paramsB',3,'p_paramsB','parser.py',998),
  ('paramsB -> empty','paramsB',1,'p_paramsB','parser.py',999),
  ('empty -> <empty>','empty',0,'p_empty','parser.py',1002),
]
